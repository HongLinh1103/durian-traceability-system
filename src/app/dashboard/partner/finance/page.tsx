...
export default async function Page({
    ...
    const defaultProcessingExpenses = [
        ...
        { id: "exp-proc-7", category: "OTHER" as PartnerExpenseCategory, title: "Chi phí tiếp khách & đàm phán hợp đồng xuất khẩu nông sản", amount: 6800000, paidAmount: 6800000, debtAmount: 0, status: "PAID" as ExpensePaymentStatus, expenseDate: "2026-08-26T09:00:00.000Z", paymentMethod: "Chuyển khoản", recipient: "Đoàn đối tác thu mua Trung Quốc & WinMart", note: "Tiếp đón và làm việc với đoàn kiểm tra xưởng chế biến", receiptImageUrl: null, payments: [] },
        { id: "exp-proc-8", category: "OTHER" as PartnerExpenseCategory, title: "In ấn tem nhãn phụ tiếng Trung, tem QR và văn phòng phẩm", amount: 4500000, paidAmount: 4500000, debtAmount: 0, status: "PAID" as ExpensePaymentStatus, expenseDate: "2026-08-27T08:30:00.000Z", paymentMethod: "Chuyển khoản", recipient: "Công ty TNHH In ấn & Bao bì Ánh Dương", note: "In 15.000 tem QR và nhãn phụ tiếng Trung xuất khẩu", receiptImageUrl: null, payments: [] },
        { id: "exp-proc-9", category: "OTHER" as PartnerExpenseCategory, title: "Trang bị đồng phục bảo hộ, ủng cao su & găng tay phòng sạch", amount: 8200000, paidAmount: 8200000, debtAmount: 0, status: "PAID" as ExpensePaymentStatus, expenseDate: "2026-08-21T07:45:00.000Z", paymentMethod: "Chuyển khoản", recipient: "Đại lý Bảo hộ Lao động Tân Tiến", note: "Cấp phát trang phục phòng vô trùng cho 40 công nhân", receiptImageUrl: null, payments: [] },
        { id: "exp-proc-10", category: "OTHER" as PartnerExpenseCategory, title: "Quan trắc môi trường và kiểm định nước xả thải xưởng chế biến", amount: 5000000, paidAmount: 5000000, debtAmount: 0, status: "PAID" as ExpensePaymentStatus, expenseDate: "2026-08-29T10:00:00.000Z", paymentMethod: "Chuyển khoản", recipient: "Trung tâm Quan trắc Môi trường Đồng Nai", note: "Kết quả kiểm nghiệm đạt chuẩn QCVN xưởng chế biến", receiptImageUrl: null, payments: [] },
        { id: "exp-proc-11", category: "EQUIPMENT_MAINTENANCE" as PartnerExpenseCategory, title: "Bảo dưỡng định kỳ hệ thống băng chuyền & hầm cấp đông IQF", amount: 8500000, paidAmount: 8500000, debtAmount: 0, status: "PAID" as ExpensePaymentStatus, expenseDate: "2026-08-25T14:00:00.000Z", paymentMethod: "Chuyển khoản", recipient: "Công ty Kỹ thuật Cơ điện Lạnh Miền Nam", note: "Bảo dưỡng máy nén khí, nạp gas R404A định kỳ", receiptImageUrl: null, payments: [] },
    ];
    ...
    const effectiveRole: "COLLECTOR" | "PROCESSING_FACILITY" =
        session.user.role === "COLLECTOR" && facility.type === "COLLECTOR"
            ? "COLLECTOR"
            : "PROCESSING_FACILITY";
