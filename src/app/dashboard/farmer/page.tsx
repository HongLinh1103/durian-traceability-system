    ...
    return (
        <main className="mx-auto min-h-screen max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
            ...
            <section className="rounded-[28px] border border-white/70 bg-white/90 px-5 py-4 shadow-soft backdrop-blur">
                <p className="text-sm font-semibold text-brand-700">Trang chủ nông dân</p>
            ...
            <Card className="rounded-3xl border-slate-200 shadow-sm">
                <CardContent className="flex flex-wrap items-center justify-between gap-4 p-6">
                    ...
                    <Button asChild className="h-11 rounded-2xl bg-brand-600 font-bold text-white hover:bg-brand-700 shadow-soft"><Link href="/dashboard/farmer/plans">Mở kế hoạch<ChevronRight className="ml-2 h-4 w-4" /></Link></Button>
                </CardContent>
            </Card>
        </main>
    );
