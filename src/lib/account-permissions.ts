...
export const ACCOUNT_PERMISSIONS_BY_ROLE: Record<string, AccountPermission[]> = {
    FARMER: [
        ...
        { key: "FARMER_HARVESTS", label: "Sổ thu hoạch", path: "/dashboard/farmer/harvests" },
        { key: "MATERIAL_CATALOG", label: "Shop vật tư", path: "/materials" },
        { key: "FARMER_INVENTORY", label: "Kho vật tư của tôi", path: "/materials/inventory" },
        { key: "MATERIAL_STORES", label: "Cửa hàng vật tư", path: "/materials/stores" },
        { key: "FARMER_CART", label: "Giỏ hàng", path: "/cart" },
        { key: "FARMER_ORDERS", label: "Đơn mua hàng của tôi", path: "/orders" },
    ...
    PROCESSING_FACILITY: [
        ...
        { key: "PROCESSING_GRADING", label: "Nhập hàng", path: "/dashboard/processing/grading" },
        { key: "PROCESSING_PREPROCESSING", label: "Tiếp nhận & Sơ chế", path: "/dashboard/processing/preprocessing" },
        { key: "PROCESSING_BATCHES", label: "Đóng gói & Nhập kho", path: "/dashboard/processing/processing" },
