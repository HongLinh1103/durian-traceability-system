...
async function main() {
    ...
    // ─── Dữ liệu minh họa GACC: Công ty TNHH MTV Kim Quy, Nam Cát Tiên, Đồng Nai ───
    const triAnRegion = await prisma.growingRegion.upsert({
        where: { code: "VN - DNOR - 0269" },
        update: {
    ...
    await prisma.areaManagerApplication.upsert({
        ...
        update: {
            ...
            organizationName: "Ban quản lý vùng trồng sầu riêng Công ty TNHH MTV Kim Quy",
            taxCode: "3601234567",
            position: "Trưởng BQL",
            officeProvince: "Đồng Nai",
            officeDistrict: "Không áp dụng",
            officeWard: "Nam Cát Tiên",
            officeDetailedAddress: "Xã Nam Cát Tiên, tỉnh Đồng Nai",
    ...
    console.log("   [OK] Seeded AREA_MANAGER 0909123456 and region VN - DNOR - 0269");
